...
interface MemberPinRouteContext {
  params: Promise<{ id: string }>;
}

export async function POST(request: NextRequest, context: MemberPinRouteContext) {
  ...
  try {
    ...
    return createBackendResponse(
      await getAdminMemberService().issueMemberPin(id, actorResult.data!),
