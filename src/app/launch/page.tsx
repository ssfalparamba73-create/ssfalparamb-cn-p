  ...
  return (
    <div className="relative mx-auto w-[clamp(225px,20vw,335px)] rotate-[2deg] rounded-[3.4rem] border-[9px] border-[#111827] bg-white p-2.5 shadow-[10px_18px_28px_rgba(15,23,42,0.24)]">
      ...
      <div className="overflow-hidden rounded-[2.6rem] bg-white">
        <div className="flex items-center justify-between px-5 pb-4 pt-8"><span className="font-cooper text-3xl text-[#2563eb]">Atiyya</span><span className="flex size-9 items-center justify-center rounded-full bg-[#eff6ff] text-[#2563eb]"><UserRound className="size-5" /></span></div>
...
export default function LaunchPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-white">
      ...
      <section className="flex min-h-screen items-center justify-center px-6 text-center md:hidden"><div className="max-w-sm rounded-3xl border border-slate-200 bg-white p-8 shadow-sm"><p className="font-cooper text-4xl tracking-wide text-[#2563eb]">Atiyya</p><h1 className="mt-4 text-xl font-semibold text-slate-900">Open this launch page on a desktop</h1><p className="mt-2 text-sm leading-6 text-slate-500">The launch artwork is designed for desktop screens.</p><Link href="/" className="mt-6 inline-flex rounded-xl bg-[#2563eb] px-5 py-3 font-semibold text-white">Open landing page</Link></div></section>
    </main>
  );
}
