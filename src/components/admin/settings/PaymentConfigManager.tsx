    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input defaultValue="ssfalparamba@okaxis" className="bg-slate-50 dark:bg-slate-950" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input placeholder="https://..." className="bg-slate-50 dark:bg-slate-950" />
              <p className="text-xs text-slate-500">If left blank, the system will auto-generate a QR code based on the UPI ID.</p>
            </div>
          </div>
          <div className="flex justify-end pt-2">
            <Button onClick={() => handleSave('UPI')} className="bg-blue-600 hover:bg-blue-700 text-white">
      ...
      <Card className="border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end pt-2">
            <Button onClick={() => handleSave('Dues')} className="bg-blue-600 hover:bg-blue-700 text-white">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input defaultValue="REC" className="bg-slate-50 dark:bg-slate-950 font-mono uppercase" />
            </div>
            <div className="space-y-2">
          ...
          <div className="flex justify-end pt-2">
            <Button onClick={() => handleSave('Receipt')} className="bg-blue-600 hover:bg-blue-700 text-white">
