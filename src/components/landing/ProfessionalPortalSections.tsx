...
const steps = [
  ...
  },
  {
    ...
    description: "Check your applicable Educational Subscriptions, selected payment period, and total amount before proceeding to payment.",
  },
  {
    icon: ReceiptText,
    title: "Get your receipt",
    description: "Digital receipts are issued instantly after subscriptions payment is confirmed. All records are available in your member profile.",
  },
];
...
const assurances = [
  {
    ...
    description: "A dedicated portal for Atiyya Group registered members to manage membership subscriptions and records.",
  },
  {
    icon: FileCheck2,
...
const faqs = [
  ...
  {
    question: "What are the Educational Subscriptions for?",
    answer: "Educational Subscriptions cover the member's active membership in the Atiyya Group for the applicable period. The exact amount and rules are published before payment.",
  },
  {
      ...
      <section className="border-t border-white/70 bg-white/35 py-12 backdrop-blur-xl md:py-16">
        <div className="container space-y-8">
          <div className="mx-auto max-w-2xl space-y-3 text-center">
            ...
            <h2 className="text-2xl font-black tracking-tight text-slate-950 md:text-3xl">Membership subscriptions management in 3 clear steps</h2>
            <p className="text-sm font-medium leading-6 text-slate-600 md:text-base">Registered members can review their subscriptions, pay online or track cash payments, and access committee support from one official portal.</p>
          </div>
      ...
      <section className="border-t border-white/70 bg-white/55 py-12 backdrop-blur-xl md:py-16">
        <div className="container grid grid-cols-1 gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-10">
          <div className="space-y-4">
            ...
            <p className="text-sm font-medium leading-6 text-slate-600 md:text-base">Our public pages clearly explain the portal's purpose, subscriptions rules, payment policies, and available support — no login required to review.</p>
            <div className="flex flex-col gap-3 sm:flex-row">
              <Button asChild className="h-11 bg-blue-600 text-white hover:bg-blue-700"><Link href="/contribution-details">subscriptions & payment details <ArrowRight className="ml-2 size-4" /></Link></Button>
