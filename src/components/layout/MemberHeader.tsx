    ...
    <header className="sticky top-0 z-40 w-full bg-[#F6F8FC] border-b border-[#E5EAF3]">
      <div className="flex h-16 items-center justify-between px-4 md:px-8 w-full relative">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <button 
            type="button" 
            className="relative size-10 md:size-11 rounded-full bg-[#F8FAFC] border border-[#E2E8F0] shadow-[0_4px_12px_rgba(15,23,42,0.08)] text-slate-600 flex items-center justify-center transition-all hover:-translate-y-0.5 hover:bg-white hover:text-slate-900 shrink-0"
          >
            <Bell className="size-4.5 md:size-5" />
            <span className="absolute top-2 md:top-2.5 right-2 md:right-2.5 size-2 md:size-2.5 rounded-full bg-red-500 ring-2 ring-white"></span>
          </button>
          ...
          <div className="relative" ref={dropdownRef}>
            <div 
              ...
              className="relative size-10 flex items-center justify-center rounded-full overflow-hidden bg-blue-100 border-2 border-white shadow-sm shrink-0 cursor-pointer hover:ring-2 hover:ring-blue-100 transition-all"
            >
            ...
            <AnimatePresence>
              {isMenuOpen && (
                <motion.div 
                  ...
                  className="absolute right-0 mt-3 w-56 rounded-2xl border border-white bg-white p-2 shadow-xl backdrop-blur-3xl"
                >
                  <div className="px-3 py-3 text-sm text-slate-500 font-medium border-b border-slate-100 mb-2">
                  ...
                  <button className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
