...
export function mapMemberDto(member: MemberDTO): Member {
  return {
    ...
    studentCourse: member.studentCourse,
    studentInstitution: member.studentInstitution,
    isMuthaallim: member.isMuthaallim,
    muthaallimInstitution: member.muthaallimInstitution,
