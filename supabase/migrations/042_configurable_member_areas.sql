-- Add configurable member Areas / Branches to the existing unit settings JSONB store.
...
VALUES (
  ...
  'Ordered Area / Branch options used by member forms and filters',
  TRUE
)
...
BEGIN
  ...
  IF p_input ? 'areas' AND (
    ...
    RAISE EXCEPTION 'Invalid Areas / Branches configuration' USING ERRCODE = '22023';
  END IF;
